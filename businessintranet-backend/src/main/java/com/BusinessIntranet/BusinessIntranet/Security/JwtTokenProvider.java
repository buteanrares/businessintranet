...
import com.BusinessIntranet.BusinessIntranet.UserPrincipal.UserPrincipal;
...
public class JwtTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create()
                .withIssuer(SecurityConstant.BUSINESSINTRANET_LLC)
                .withAudience(SecurityConstant.BUSINESSINTRANET_ADMINISTRATION)
